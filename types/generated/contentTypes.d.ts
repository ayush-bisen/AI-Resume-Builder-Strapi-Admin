...
export interface ApiCreateResumeCreateResume
  extends Struct.CollectionTypeSchema {
  collectionName: 'create_resumes';
  info: {
    description: '';
    displayName: 'create-resume';
    pluralName: 'create-resumes';
    singularName: 'create-resume';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ats_score: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    certfications: Schema.Attribute.Component<
    ...
    interests: Schema.Attribute.Component<'interests.interests', true>;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::create-resume.create-resume'
    > &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::create-resume.create-resume': ApiCreateResumeCreateResume;
